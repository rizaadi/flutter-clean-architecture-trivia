...
void main() {
  ...
  group('getConcreteNumberTivia', () {
    final tNumber = 1;
    final tNumberTriviaModel = NumberTriviaModel(number: tNumber, text: 'test tivia');
    ...
    runTestsOffline(() {
      test('shuld return last lcally cached data when the cached data is present', () async {
      ...
      test('should return CacheFailure when there is on cached data present', () async {
  ...
  group('getRandomNumberTivia', () {
    final tNumberTriviaModel = NumberTriviaModel(number: 123, text: 'test rivia');
    final NumberTrivia tNumberTrivia = tNumberTriviaModel;
    setUp(() {
      when(() => mockLocalDataSource.cacheNumberTrivia(tNumberTriviaModel)).thenAnswer((_) async {});
